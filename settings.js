const fs = require('fs');
if (fs.existsSync('config.env')) require('.').config({ path: './config.env' });
function convertToBool(text, fault = 'true') {
    return text === fault ? true : false;
}
module.exports = {
SESSION_ID: process.env.SESSION_ID || "𝐋ᴀᴋᴀ-𝐌ᴅ=N4wzCSTb#oWD-kB2zZMvmy0lDCdvOPxZ_i5SUOwozwBmhjlzOxmA",
